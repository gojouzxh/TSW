...
<div class="main-wrapper">
  ...
  <div class="game-header">
    <div class="game-title-top">▶ SELECT YOUR FIGHTER ◀</div>
  ...
  <div id="select-screen">
    <div class="select-label">▶ CHOOSE PLAYER ◀</div>
    ...
    <div class="detail-container">
      ...
      <div class="detail-main">
        ...
        <div class="info-side">
          ...
          <!-- Buttons -->
          <div class="btn-row">
            <button class="retro-btn btn-back" onclick="goBack()">◀ BACK</button>
            <button class="retro-btn btn-edit" id="toggle-edit-btn" onclick="toggleEdit()">✎ EDIT</button>
            <button class="retro-btn btn-save" id="save-btn" onclick="saveEdit()" style="display:none;">✔ SAVE</button>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="game-footer">
    ◆ P1 VS P2 VS P3 VS P4 VS P5 VS P6 ◆
    <div class="credits-line">RETRO ROSTER v1.0 — ALL RIGHTS RESERVED</div>
  </div>
</div>
...
const characters = [
  {
    ...
    abilities: [
      { icon: "🌑", name: "Shadow cum", desc: "Teleport behind the enemy shoot out cum." },
      { icon: "⚡", name: "cum strike", desc: "Lightning fast combo that stuns." },
      { icon: "🔪", name: "Death goon", desc: "Forces the enemy to goon till death." }
    ]
  },
  {
    id: 2,
    ...
    abilities: [
      { icon: "🛡️", name: "Emotional bounce back ", desc: "Absorb all Emotional damage for 3 seconds." },
      { icon: "💥", name: "Mama calling", desc: "Summon the mother for 1 minute to deal damage." },
      { icon: "🔩", name: "Ghosted Again", desc: "Disappear 5 seconds, enemy feel confusion and slighty hurt." }
    ]
  },
  {
    id: 3,
    ...
    abilities: [
      { icon: "🐍", name: "Thirst trap", desc: "set a trap to lure the baddies." },
      { icon: "💀", name: "Loud mouth", desc: "talk Loud without getting exhausted." },
      { icon: "🎯", name: "Exhibition", desc: "Sleep while his tummy to deal damage to enemy and confuse them." }
    ]
  },
  {
    id: 4,
    ...
    abilities: [
      { icon: "🔥", name: "monkey calling", desc: "summon his inner monkey." },
      { icon: "💣", name: "Rage Mode", desc: "when rage baited muted for entire day." },
      { icon: "🌋", name: "Loverboy Mode", desc: "Charm- control emotional damage." }
    ]
  },
  {
    id: 5,
    ...
    abilities: [
      { icon: "⚡", name: "typing", desc: "Devastating critical immaculate responsiveness." },
      { icon: "❄️", name: "Delusional", desc: "confuse the enemy and herself." },
      { icon: "🌀", name: "final acceptance", desc: "Its over." }
    ]
  },
  {
    id: 6,
    ...
    abilities: [
      { icon: "⚡", name: "Lightning rod", desc: "Unfolds his dick to deal thunder damage." },
      { icon: "⚡", name: "Lightning power up", desc: "Pause to distract the enemy." },
      { icon: "⚡", name: "Divine Possession", desc: "summon his all mighty pikachu to control his body." }
    ]
  }
];
...
function renderAbilities(idx) {
  ...
  char.abilities.forEach((ab, ai) => {
    ...
    li.innerHTML = `
      <span class="ability-icon">${ab.icon || '⚔️'}</span>
      <div class="ability-text-wrap">
        <span class="ability-name">${ab.name}</span>
        <span class="ability-desc">${ab.desc}</span>
      </div>
      <div class="ability-remove-wrap">
        <button class="btn-remove" onclick="removeAbility(${ai})" title="Remove ability">✕</button>
      </div>
    `;
    list.appendChild(li);
  });
...
function closeEditPanel() {
  ...
  document.getElementById('toggle-edit-btn').textContent = '✎ EDIT';
...
function addAbility() {
  if (currentCharIndex === null) return;
  const icon = document.getElementById('new-ability-icon').value.trim() || '⚔️';
